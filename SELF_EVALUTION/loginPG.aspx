<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginPG.aspx.cs" Inherits="SELF_EVALUTION.WebForm1" %>
...
<head runat="server">
    ...
    <style>
        ...
        body {
            background-image: url("https://www.corporatelivewire.com/images/blogs/1764/1122309292.jpg");
        ...
        function login() {
            ...
            if (allowedEmailIds.includes(enteredEmail)) {
                ...
                if (enteredPassword === "CorrectPassword") { // Replace "CorrectPassword" with your actual password validation code
                    window.location.href = "https://localhost:44360/HospitalREG.aspx"; // Redirect to logged-in page
                } else {
